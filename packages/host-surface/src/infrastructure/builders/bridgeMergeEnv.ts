import { buildDeclarativeBridgeTable } from '@microverse/runtime-bridge';
 ...
 *
 * @param host - Your host context, already extended with the capability registry symbol from `@microverse/host-surface`.
